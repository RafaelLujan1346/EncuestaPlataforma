...
<div class="row mt-4">
  <!-- Aquí tus gráficos, tablas y carrusel -->
</div>
@endsection
...
<script>
  ...
  new Chart(ctx1, {
    ...
    options: {
      ...
      scales: {
        y: { grid: { drawBorder: false, drawOnChartArea: true, drawTicks: false, borderDash: [5,5] }, ticks: { display: true, padding: 10, color: '#fbfbfb', font: { size: 11, family: "Open Sans", style: 'normal', lineHeight: 2 } } },
